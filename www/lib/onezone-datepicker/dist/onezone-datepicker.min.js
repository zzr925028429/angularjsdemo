!function (e, t) {
  ...
  if (e.getElementsByTagName("head")[0].appendChild(a), a.styleSheet)a.styleSheet.disabled || (a.styleSheet.cssText = t); else try {
    a.innerHTML = t
  } catch (n) {
    a.innerText = t
  }
  ...
  function a(t, a, n, i, r, o, d) {
    ...
    if (angular.isDefined(i) && angular.isArray(i))for (var g = 0; g < i.length; g++)if (p = new Date(i[g].getFullYear(), i[g].getMonth(), i[g].getDate()), e(p, c))return !0;
  ...
  function n(e, t) {
    if (angular.isDefined(e) && angular.isArray(e) && e.length > 0)for (var a = 0; a < e.length; a++) {
      var n = e[a];
  ...
  var r = {}, o = function (e) {
    var t, a, n, i, r, o = !1, d = !1, c = !1, p = !1, u = !0, g = [], h = !1, k = !1, b = !1, f = !1, D = [], y = [];
    ...
    for (var a = 0, n = [], i = [], r = e; t >= r; r++)i.push(r), a++, a % 12 === 0 && (n.push({years: i}), i = []);
    return i.length > 0 && n.push({years: i}), n
  }, c = function (e, t) {
    if (angular.isDefined(e) && angular.isArray(e))for (var a = 0; a < e.length; a++) {
    ...
    for (var a = !1, n = 0, r = [], o = t(e.date, e.mondayFirst), d = o.getMonth(); !a;) {
      r.push({days: i(o, e.date, e.disablePastDays, e.disableWeekend, e.disableDates, e.disableDaysOfWeek, e.displayFrom, e.displayTo, e.highlights)}), o.setDate(o.getDate() + 7);
